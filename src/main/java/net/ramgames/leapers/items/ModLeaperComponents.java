...
public class ModLeaperComponents {
    ...
    public static final Fixture GLASS_FIXTURE = new Fixture(new Identifier(Leapers.MOD_ID, "item/fixtures/glass_leaper"), new Identifier(Leapers.MOD_ID, "textures/item/fixtures/glass_fixture"), new Identifier(Leapers.MOD_ID, "textures/block/leap_stone/fixtures/glass_fixture.png"), TransportType.FIXED, 1);
    public static final Fixture GOLD_FIXTURE = new Fixture(new Identifier(Leapers.MOD_ID, "item/fixtures/gold_leaper"), new Identifier(Leapers.MOD_ID, "textures/item/fixtures/gold_fixture"), new Identifier(Leapers.MOD_ID, "textures/block/leap_stone/fixtures/gold_fixture.png"), TransportType.RELATIVE, 4);
    public static final Fixture MEMORIA_FIXTURE = new Fixture(new Identifier(Leapers.MOD_ID, "item/fixtures/memoria_leaper"), new Identifier(Leapers.MOD_ID, "textures/item/fixtures/memoria_fixture"), new Identifier(Leapers.MOD_ID, "textures/block/leap_stone/fixtures/memoria_fixture.png"), TransportType.DYNAMIC, 8);
    public static final Fixture QUARTZ_FIXTURE = new Fixture(new Identifier(Leapers.MOD_ID, "item/fixtures/quartz_leaper"), new Identifier(Leapers.MOD_ID, "textures/item/fixtures/quartz_fixture"), new Identifier(Leapers.MOD_ID, "textures/block/leap_stone/fixtures/quartz_fixture.png"), TransportType.FIXED, 10);
