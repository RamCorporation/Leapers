...
public interface ModShapes {
    ...
    VoxelShape REDSTONE_RAY_SOUTH = Stream.of(
            Block.createCuboidShape(5, 2, 1, 11, 8, 2),
            Block.createCuboidShape(0, 0, 0, 16, 2, 16),
            Block.createCuboidShape(11, 2, 2, 13, 10, 4),
            Block.createCuboidShape(5, 8, 2, 11, 10, 4),
            Block.createCuboidShape(3, 2, 2, 5, 10, 4),
            Block.createCuboidShape(5, 2, 4, 11, 8, 5)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();

    VoxelShape REDSTONE_RAY_WEST = Stream.of(
            Block.createCuboidShape(14, 2, 5, 15, 8, 11),
            Block.createCuboidShape(0, 0, 0, 16, 2, 16),
            Block.createCuboidShape(12, 2, 11, 14, 10, 13),
            Block.createCuboidShape(12, 8, 5, 14, 10, 11),
            Block.createCuboidShape(12, 2, 3, 14, 10, 5),
            Block.createCuboidShape(11, 2, 5, 12, 8, 11)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();

    VoxelShape REDSTONE_RAY_NORTH = Stream.of(
            Block.createCuboidShape(5, 2, 14, 11, 8, 15),
            Block.createCuboidShape(0, 0, 0, 16, 2, 16),
            Block.createCuboidShape(3, 2, 12, 5, 10, 14),
            Block.createCuboidShape(5, 8, 12, 11, 10, 14),
            Block.createCuboidShape(11, 2, 12, 13, 10, 14),
            Block.createCuboidShape(5, 2, 11, 11, 8, 12)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();

    VoxelShape REDSTONE_RAY_EAST = Stream.of(
            Block.createCuboidShape(1, 2, 5, 2, 8, 11),
            Block.createCuboidShape(0, 0, 0, 16, 2, 16),
            Block.createCuboidShape(2, 2, 3, 4, 10, 5),
            Block.createCuboidShape(2, 8, 5, 4, 10, 11),
            Block.createCuboidShape(2, 2, 11, 4, 10, 13),
            Block.createCuboidShape(4, 2, 5, 5, 8, 11)
    ).reduce((v1, v2) -> VoxelShapes.combineAndSimplify(v1, v2, BooleanBiFunction.OR)).get();
