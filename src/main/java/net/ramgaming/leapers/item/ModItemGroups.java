...
public interface ModItemGroups {
    ...
    ItemGroup LEAPER_GROUP = registerItemGroup("leaper_group","Light Leapers", ModItems.SPECTRAL_CRYSTAL);
    ...
    private static ItemGroup registerItemGroup(String path,String name, Item icon) {
        ItemGroup group = FabricItemGroup.builder().icon(() -> new ItemStack(ModItems.SPECTRAL_CRYSTAL)).displayName(Text.translatable(name)).build();
